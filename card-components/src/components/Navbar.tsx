        ...
        <div className="container mx-auto flex items-center justify-center flex-wrap md:justify-between">
          ...
          <div className="flex items-center justify-center space-x-4 mt-4  md:mt-0 ">
            {isLoggedIn ? (
              ...
              <Link
                href="/signin"
                className="text-white ml-5 bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center transition duration-150 ease-in-out mb-2"
              >
                Log in
              </Link>
            )}
